      ...
      <div className="Contact_Base">
        <div className="Contact_Information">
          <div className="Location">
            ...
            <p class="First">2715 Ash Dr. San Jose, South Dakota 83475</p>
          </div>
          ...
          <div className="Contact_Email">
            ...
            <p className="First">Ecobazaar@gmail.com</p>
            <p>Ecobazaar.CustomerService@gmail.com</p>
          </div>
          <div className="Divider_Horizontal"></div>
          <div className="Contact_Phone">
            ...
            <p className="First">(219) 555-0114</p>
            <p>(164) 333-0487</p>
          </div>
        </div>
        <div className="Contact_Inquiry">
          <div className="Contact_Title">
            ...
            <p className="Color_Gray">
              Do yo fancy saying hi to me or you want to get started with your
          ...
          <div className="Contact_Form">
            ...
            <div class="Contact_Messege">
              <textarea
                ...
                className="Input_Design"></textarea>
            </div>

            <button className="Btn-Fill Btn-Small">Send Messege</button>
          </div>
        </div>
      </div>
    </>
